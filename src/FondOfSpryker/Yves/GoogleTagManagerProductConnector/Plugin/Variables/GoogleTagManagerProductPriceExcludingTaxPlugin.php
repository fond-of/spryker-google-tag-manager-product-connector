 ...
 */
class GoogleTagManagerProductPriceExcludingTaxPlugin extends AbstractPlugin implements GoogleTagManagerVariableBuilderPluginInterface
{
    /**
     * @param string $page
     * @param array $params
    ...
    public function addVariable(string $page, array $params): array
    {
        return $this->getFactory()
            ...
            ->getPriceExcludingTax($page, $params);
    }
}
